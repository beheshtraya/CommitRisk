...
classifier = RandomForestClassifier(n_estimators =500,criterion ="entropy",max_depth =None,
                                    min_samples_split=2,min_samples_leaf =1,
                                    min_weight_fraction_leaf =0,max_features =None,
                                    random_state =0,max_leaf_nodes=1500,
                                    min_impurity_decrease=0,class_weight =None,
                                    bootstrap=False,oob_score=False,n_jobs=-1,warm_start=True)
